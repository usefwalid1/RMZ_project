...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="nav">
        ...
        <div class="nav_col nav_list">
            <ul>
                ...
                <li class="nav_item"><a href="#">Attendance</a></li>
    ...
    <div class="txt_center padding_20_top">
            <label class="txt_underlogo">My Courses</label>
    </div></br></br></br>
  ...
  <table>
    ...
    <tr>
      ...
      <td><a href="{{url('drop_course',$course->course_id)}}" class="reg_bg">Drop Course</a></td>
    </tr>
    @endforeach
  </table>
