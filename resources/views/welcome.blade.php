...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="col ">
        ...
        <div class="txt_center padding_40_btn padding_170_top">
            <label class="txt_underlogo">Choose type of registration !</label>
        </div>

        <div class="txt_center reg_font_adj ">
            <a href="#" class="reg_bg">Attendance registration</a>
        </div>
        
        <div class="txt_center reg_font_adj padding_30_top">
            <a href="#" class="reg_bg">Leave registration</a>
        </div>

    </div>

    <div class="col padding_70_top">
       <img src="{{url('images/download2.jpg')}}" class="home_img">

        <div class="txt_center padding_20_top">
            <label class="txt_underlogo">Find your Knowlege with your online school</label>
        </div>
    </div>
